...
# ===== CONFIGURATION =====
DATA_DIR   = r"D:\data\BudgetODMR\26-06-2026\data"
RUNS_DIR   = os.path.join(DATA_DIR, "odmr_runs_prueba")
RUNS_GLOB  = "run_*.csv"
OUTPUT_CSV = os.path.join(DATA_DIR, "odmr_runs_prueba.csv")
SAVE_FIG   = os.path.join(DATA_DIR, "odmr_runs_prueba.png")   # None to skip saving
