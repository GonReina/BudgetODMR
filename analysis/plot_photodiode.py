...
DATA_DIR   = r"D:\data\BudgetODMR\25-06-2026\"
INPUT_FILE = os.path.join(DATA_DIR, "odmr_runs_wide.csv")
SAVE_FIG   = os.path.join(DATA_DIR, "odmr_runs_wide.png")   # set to None to skip saving
